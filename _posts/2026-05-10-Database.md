---
layout: default
title: "What is Database? (How hackers think...)"
date: 2026-05-10
categories: Hacking
---
...
### <span class="text-red">Database Architecture</span> (DB Types)
...
#### <span class="text-red">Hacker's View</span> (Web Hacking)
...
#### <span class="text-red">관점 비교</span> (입력 값 검증)
